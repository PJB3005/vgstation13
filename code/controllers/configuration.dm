/var/list/datum/game_mode/gamemode_cache
...
/datum/configuration/New()
	...
	for (var/T in L)
		...
		global.gamemode_cache[M.config_tag] = M // So we don't instantiate them repeatedly.
		if (M.config_tag)
...
/datum/configuration/proc/get_runnable_modes()
	...
	for (var/datum/game_mode/M in gamemode_cache)
		if (!(M.config_tag in modes) || probabilities[M.config_tag] <= 0)
			continue
