...
/obj/effect/sigil/transgression/activation(var/mob/living/L as mob)
	...
	if(iscultist(L))
		to_chat(L, "<span class='sinister'>\"Watch your step, wretch.\"</span>")
	else
		to_chat(L, "<span class='warning'>An unseen force renders you motionless!</span>")

	L.Stun(4)
	if(prob(iscultist(L) ? 65 : 35))
		L.adjustBruteLoss(10)
		to_chat(L, "<span class='danger'>It hurts.</span>")
