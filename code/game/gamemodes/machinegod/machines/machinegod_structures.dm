...
/obj/machinery/s_gateway/proc/activate(var/doom = 0) //1 is 6+, portal becomes dangerous to enemies; 2 is 9+, portal destroys enemies
	...
	if(doom == 2)
		...
		for(var/mob/living/L in view(src, 7))
			...
			to_chat(L, "<span class='danger' style='font-size:16pt'>A relentless, otherworldly energy floods every part of your body, causing you previously unimaginable amounts of pain.</span>")
