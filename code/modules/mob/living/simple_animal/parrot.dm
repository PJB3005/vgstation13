...
/mob/living/simple_animal/parrot/attack_paw(mob/living/carbon/humanoid/monkey/M as mob)
	attack_hand(M)

/mob/living/simple_animal/parrot/attack_alien(mob/living/carbon/humanoid/monkey/M as mob)
	attack_hand(M)
