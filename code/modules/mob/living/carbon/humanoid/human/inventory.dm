/mob/living/carbon/humanoid/human/verb/quick_equip()
...
/mob/living/carbon/humanoid/human/get_all_slots()
	. = get_head_slots() | get_body_slots()

/mob/living/carbon/humanoid/human/proc/get_body_slots()
	return list(
...
/mob/living/carbon/humanoid/human/proc/get_head_slots()
	return list(
//also head ordered
		head,
		wear_mask,
...
/mob/living/carbon/humanoid/human/get_clothing_items(var/list/filter)
...
/mob/living/carbon/humanoid/human/proc/check_obscured_slots()
...
/mob/living/carbon/humanoid/human/proc/check_hidden_head_flags(var/hidden_flags = 0)
	return check_hidden_flags(get_clothing_items(get_head_slots()), hidden_flags)

/mob/living/carbon/humanoid/human/proc/check_hidden_body_flags(var/hidden_flags = 0)
	return check_hidden_flags(get_clothing_items(get_body_slots()), hidden_flags)

/mob/living/carbon/humanoid/human/proc/check_hidden_flags(var/list/items, var/hidden_flags = 0)
...
/mob/living/carbon/humanoid/human/proc/equip_in_one_of_slots(obj/item/W, list/slots, act_on_fail = 1)
...
/mob/living/carbon/humanoid/human/proc/is_on_ears(var/typepath)
	return istype(ears,typepath)

/mob/living/carbon/humanoid/human/proc/is_in_hands(var/typepath)
...
/mob/living/carbon/humanoid/human/put_in_hand_check(obj/item/I, this_hand)
...
/mob/living/carbon/humanoid/human/get_item_by_slot(slot_id)
	switch(slot_id)
		if(slot_back)
			return back
		if(slot_wear_mask)
...
/mob/living/carbon/humanoid/human/proc/has_organ(name)
	var/datum/organ/external/O = organs_by_name[name]

	return (O && !(O.status & ORGAN_DESTROYED) )

/mob/living/carbon/humanoid/human/proc/has_organ_for_slot(slot)
	switch(slot)
		if(slot_back)
...
/mob/living/carbon/humanoid/human/u_equip(obj/item/W as obj, dropped = 1)
	if(!W)	return 0
...
/mob/living/carbon/humanoid/human/equip_to_slot(obj/item/W as obj, slot, redraw_mob = 1)
	if(!slot) return
	if(!istype(W)) return
...
/obj/effect/equip_e/monkey
	name = "monkey"
	var/mob/living/carbon/humanoid/monkey/target = null
...
/mob/living/carbon/humanoid/human/get_multitool(var/active_only=0)
