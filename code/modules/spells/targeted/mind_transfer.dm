/spell/targeted/mind_transfer
	...
	compatible_mobs = list(/mob/living/carbon/humanoid/human,/mob/living/carbon/humanoid/monkey) //which types of mobs are affected by the spell. NOTE: change at your own risk
