...
/datum/surgery_step/butt/slice_cheek/can_use(mob/living/user, mob/living/carbon/humanoid/human/target, target_zone, obj/item/tool)
	return ..() && target_zone == "groin" && target.op_stage.butt == 0 && istype(target)


/datum/surgery_step/butt/slice_cheek/begin_step(mob/user, mob/living/carbon/humanoid/human/target, target_zone, obj/item/tool)
...
/datum/surgery_step/butt/slice_cheek/end_step(mob/living/user, mob/living/carbon/humanoid/human/target, target_zone, obj/item/tool)
...
/datum/surgery_step/butt/slice_cheek/fail_step(mob/living/user, mob/living/carbon/humanoid/human/target, target_zone, obj/item/tool)
...
/datum/surgery_step/butt/seperate_anus/can_use(mob/living/user, mob/living/carbon/humanoid/human/target, target_zone, obj/item/tool)
	return ..() && target.op_stage.butt == 1


/datum/surgery_step/butt/seperate_anus/begin_step(mob/user, mob/living/carbon/humanoid/human/target, target_zone, obj/item/tool)
...
/datum/surgery_step/butt/seperate_anus/end_step(mob/living/user, mob/living/carbon/humanoid/human/target, target_zone, obj/item/tool)
...
/datum/surgery_step/butt/seperate_anus/fail_step(mob/living/user, mob/living/carbon/humanoid/human/target, target_zone, obj/item/tool)
...
/datum/surgery_step/butt/saw_hip/can_use(mob/living/user, mob/living/carbon/humanoid/human/target, target_zone, obj/item/tool)
	return ..() && target_zone == "groin" && target.op_stage.butt == 2

/datum/surgery_step/butt/saw_hip/begin_step(mob/user, mob/living/carbon/humanoid/human/target, target_zone, obj/item/tool)
...
/datum/surgery_step/butt/saw_hip/end_step(mob/living/user, mob/living/carbon/humanoid/human/target, target_zone, obj/item/tool)
...
/datum/surgery_step/butt/saw_hip/fail_step(mob/living/user, mob/living/carbon/humanoid/human/target, target_zone, obj/item/tool)
...
/datum/surgery_step/butt/cauterize_butt/can_use(mob/living/user, mob/living/carbon/humanoid/human/target, target_zone, obj/item/tool)
	return ..() && target_zone == "groin" && target.op_stage.butt == 3

/datum/surgery_step/butt/cauterize_butt/begin_step(mob/user, mob/living/carbon/humanoid/human/target, target_zone, obj/item/tool)
...
/datum/surgery_step/butt/cauterize_butt/end_step(mob/living/user, mob/living/carbon/humanoid/human/target, target_zone, obj/item/tool)
...
/datum/surgery_step/butt/cauterize_butt/fail_step(mob/living/user, mob/living/carbon/humanoid/human/target, target_zone, obj/item/tool)
