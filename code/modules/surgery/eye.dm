...
/datum/surgery_step/eye/cut_open/can_use(mob/living/user, mob/living/carbon/humanoid/human/target, target_zone, obj/item/tool)
	return ..()

/datum/surgery_step/eye/cut_open/begin_step(mob/user, mob/living/carbon/humanoid/human/target, target_zone, obj/item/tool)
...
/datum/surgery_step/eye/cut_open/end_step(mob/living/user, mob/living/carbon/humanoid/human/target, target_zone, obj/item/tool)
...
/datum/surgery_step/eye/cut_open/fail_step(mob/living/user, mob/living/carbon/humanoid/human/target, target_zone, obj/item/tool)
...
/datum/surgery_step/eye/lift_eyes/can_use(mob/living/user, mob/living/carbon/humanoid/human/target, target_zone, obj/item/tool)
	return ..() && target.op_stage.eyes == 1

/datum/surgery_step/eye/lift_eyes/begin_step(mob/user, mob/living/carbon/humanoid/human/target, target_zone, obj/item/tool)
...
/datum/surgery_step/eye/lift_eyes/end_step(mob/living/user, mob/living/carbon/humanoid/human/target, target_zone, obj/item/tool)
...
/datum/surgery_step/eye/lift_eyes/fail_step(mob/living/user, mob/living/carbon/humanoid/human/target, target_zone, obj/item/tool)
	var/datum/organ/internal/eyes/eyes = target.internal_organs_by_name["eyes"]
	var/datum/organ/external/affected = target.get_organ(target_zone)
...
/datum/surgery_step/eye/mend_eyes/can_use(mob/living/user, mob/living/carbon/humanoid/human/target, target_zone, obj/item/tool)
	return ..() && target.op_stage.eyes == 2

/datum/surgery_step/eye/mend_eyes/begin_step(mob/user, mob/living/carbon/humanoid/human/target, target_zone, obj/item/tool)
...
/datum/surgery_step/eye/mend_eyes/end_step(mob/living/user, mob/living/carbon/humanoid/human/target, target_zone, obj/item/tool)
...
/datum/surgery_step/eye/mend_eyes/fail_step(mob/living/user, mob/living/carbon/humanoid/human/target, target_zone, obj/item/tool)
	var/datum/organ/internal/eyes/eyes = target.internal_organs_by_name["eyes"]
	var/datum/organ/external/affected = target.get_organ(target_zone)
...
/datum/surgery_step/eye/cauterize/can_use(mob/living/user, mob/living/carbon/humanoid/human/target, target_zone, obj/item/tool)
	return ..()

/datum/surgery_step/eye/cauterize/begin_step(mob/user, mob/living/carbon/humanoid/human/target, target_zone, obj/item/tool)
...
/datum/surgery_step/eye/cauterize/end_step(mob/living/user, mob/living/carbon/humanoid/human/target, target_zone, obj/item/tool)
	var/datum/organ/internal/eyes/eyes = target.internal_organs_by_name["eyes"]
...
/datum/surgery_step/eye/cauterize/fail_step(mob/living/user, mob/living/carbon/humanoid/human/target, target_zone, obj/item/tool)
	var/datum/organ/internal/eyes/eyes = target.internal_organs_by_name["eyes"]
	var/datum/organ/external/affected = target.get_organ(target_zone)
